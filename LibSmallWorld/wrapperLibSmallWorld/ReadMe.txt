========================================================================
    ...
    wrapperLibSmallWorld
========================================================================

AppWizard a créé cette DLL wrapperLibSmallWorld pour vous.  

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application wrapperLibSmallWorld.

wrapperLibSmallWorld.vcxproj
...
wrapperLibSmallWorld.vcxproj.filters
