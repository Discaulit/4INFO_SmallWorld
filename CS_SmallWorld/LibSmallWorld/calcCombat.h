...
public:
	...
	*/
	int resCombat(const int pvAtq, const int pvDef, const int atq = 3, const int def = 2, const int pvMax = 5);
...
private:
	...
	*/
	bool atqGagneUnTour(const int pvAtq, const int pvDef, const int atq = 3, const int def = 2, const int pvMax = 5);
